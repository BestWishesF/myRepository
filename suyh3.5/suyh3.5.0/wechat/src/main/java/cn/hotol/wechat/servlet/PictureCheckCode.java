...
import cn.hotol.wechat.toolutil.modelutil.IdentifyingCode;
import cn.hotol.wechat.toolutil.modelutil.ImageHelper;
...
public class PictureCheckCode extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("lastVerifyCode", checkCode);
        g.dispose();
        /*JPEGImageEncoder encoder = JPEGCodec.createJPEGEncoder(response.getOutputStream());
        encoder.encode(image);*/
        ImageHelper.writeImage(image, response.getOutputStream());
