 ...
 * Date 2016-12-28.
 */
public class WaitTakeOrderDetailDto {

    private int express_id;//快递公司id
    private int add_region;//发件地区
    ...
    public List<WaitTakeCollectDetailDto> getCollects() {
        return collects;
    }

    public void setCollects(List<WaitTakeCollectDetailDto> collects) {
