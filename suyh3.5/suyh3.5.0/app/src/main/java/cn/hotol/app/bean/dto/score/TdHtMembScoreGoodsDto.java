 ...
 * Date 2016-12-17.
 */
public class TdHtMembScoreGoodsDto {

    private int memb_goods_id;//用户兑换商品记录id
    private int goods_id;//积分兑换商品id
    private String goods_img;//积分兑换商品图片路径
    private String goods_name;//积分兑换商品名称
    private int goods_score;//积分兑换商品兑换所需积分
    private int goods_state;//积分兑换商品状态
    private BigDecimal coupon_money;//积分兑换商品优惠券金额
    private int memb_id;//用户id
    private Timestamp exchange_time;//兑换时间
