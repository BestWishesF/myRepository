 ...
 * Date 2016-12-15.
 */
public class TdHtAgentDto implements Serializable {
    ...
    private String agent_id_number;//身份证号码
    ...
    private Timestamp agent_adopt_time;//通过时间
    ...
    private int agent_pay_type;//提现方式1支付宝
