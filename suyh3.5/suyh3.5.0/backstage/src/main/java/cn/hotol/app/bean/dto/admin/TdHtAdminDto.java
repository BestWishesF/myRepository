package cn.hotol.app.bean.dto.admin;
 ...
 * 管理员信息表
 */
public class TdHtAdminDto implements Serializable {

    private static final long serialVersionUID = 1L;

    private int admin_id;//主键
    private String user_name;//管理员姓名
    private String user_pass;//登录密码
    private Timestamp reg_time;//注册时间
    private String login_ip;//最后登录ip
    private Timestamp login_time;//最后登录时间
    private int is_valid;//是否有效   0是有效，1是无效
    private String phone;//手机号
    private String qq;//qq号
    private int role_id;//权限id
    private String old_user_pass;//原登录密码
    ...
    private int login_client;//登录客户端（1ios2android3wechat4web）

    private String address;//地址
    private String role_name;//角色


    public String getOld_user_pass() {
        return old_user_pass;
    }

    public void setOld_user_pass(String old_user_pass) {
        this.old_user_pass = old_user_pass;
    }
    ...
    public int getLogin_client() {
        return login_client;
    }

    public void setLogin_client(int login_client) {
