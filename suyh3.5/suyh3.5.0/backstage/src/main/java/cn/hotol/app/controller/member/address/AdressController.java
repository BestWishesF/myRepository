...
public class AdressController {
    ...
    public ModelAndView list(@RequestParam(value = "currentPage", required = true) Integer currentPage,
        ...
        ModelAndView mv = new ModelAndView("/address/index");
        mv.addObject("retInfo", addressService.memberAddressPage(memb_id,currentPage, 10));
