...
(function (b) {
    var a = {
        ...
        digitToCssRenderer: function (q, d, m, e, p, g) {
            ...
            if (d.showHRI) {
                ...
                // j += '<div style="clear:both; width: 100%; background-color: ' + d.bgColor + "; color: " + d.color + "; text-align: center; font-size: " + d.fontSize + "px; margin-top: " + d.marginHRI + 'px;">' + getGEK(e) + "</div>"
            }
    ...
    function getGEK(data) {
        var a=data.substring(0,3);
        var b=data.substring(3,6);
        var c=data.substring(6,9);
        var d=data.substring(9,12);
        return a+" "+b+" "+c+" "+d;
    }
