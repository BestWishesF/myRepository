jQuery(document).ready(function () {
    ...
    jQuery("#datepickfrom").datepicker({
        dateFormat: "yy-mm-dd"
    });
    jQuery("#datepickto").datepicker({
        dateFormat: "yy-mm-dd"
    });
    if ($("#datepickfrom").val() != null && $("#datepickfrom").val() != "") {
        $("#datepickfrom").datepicker("setDate", $("#datepickfrom").val());
    }

    if ($("#datepickto").val() != null && $("#datepickto").val() != "") {
        $("#datepickto").datepicker("setDate", $("#datepickto").val());
    }
