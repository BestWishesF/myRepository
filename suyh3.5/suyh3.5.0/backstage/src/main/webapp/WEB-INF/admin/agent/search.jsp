    ...
    <div class="centercontent tables">
        <div id="contentwrapper" class="contentwrapper">
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    var href = "${ctx}/admin/agent/searchList?currentPage="+n+"&agent_id=${retInfo.obj.agent_id}"+
                            "&agent_mobile=${retInfo.obj.agent_mobile}&agent_name=${retInfo.obj.agent_name}&father_id=${funcions.obj.father_id}";
    ...
    function lock(agent_id ,agent_state ,token){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.mark=="0"){
                    var href = "${ctx}/admin/agent/searchList?currentPage="+n+"&agent_id=${retInfo.obj.agent_id}"+
                        "&agent_mobile=${retInfo.obj.agent_mobile}&agent_name=${retInfo.obj.agent_name}&father_id=15";
