        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable" width="2400px">
                ...
                <tr>
                    ...
                    <th class="head0" width="5%">小费</th>
                    <th class="head0" width="5%">实付金额</th>
                                    ...
                                    <c:choose>
                                        <c:when test="${funcion.func_name == '修改'}">
                                            <c:if test="${retInfo.obj.exp_ord_state >0 && retInfo.obj.exp_ord_state<5}">
                                                <a class="btn_a" onclick="update(${bean.exp_ord_id})" href="###">修改</a>||
                                            </c:if>
                                        </c:when>
                                        <c:when test="${funcion.func_name == '删除'}">
                                            <c:if test="${retInfo.obj.exp_ord_state < 4 && retInfo.obj.exp_ord_state >0}">
                                                <a class="btn_a" onclick="delExpOrd(${bean.exp_ord_id})" href="###">删除</a>||
                                            </c:if>
                                        </c:when>
                                        <c:otherwise>
                                            <a class="btn_a" href="#" onclick="main('${ctx}${funcion.link_url}?currentPage=1&exp_ord_state=${retInfo.obj.exp_ord_state}&exp_ord_id=${bean.exp_ord_id}&memb_type=4&father_id=${funcion.func_id}')">${funcion.func_name}</a>||
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </td>
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    var href = "${ctx}/admin/express/order/searchList?currentPage=" + n + "&exp_ord_state=${retInfo.obj.exp_ord_state}&add_mobile_phone=${retInfo.obj.add_mobile_phone}&ht_number=${retInfo.obj.ht_number}&express_number=${retInfo.obj.express_number}&memb_type=4&father_id=${funcions.obj.father_id}";
            ...
            <script type="text/javascript">
                ...
                $("#search_button").click(function () {
                    var href = "${ctx}/admin/express/order/searchList?currentPage=1&exp_ord_state=${retInfo.obj.exp_ord_state}&add_mobile_phone=" + $("#add_mobile_phone").val() + "&ht_number=" + $("#ht_number").val() + "&express_number=" + $("#express_number").val()+"&memb_type=4&father_id=${funcions.obj.father_id}";
                    $.ajax({
                        type:'GET',
                        url:href,
                        dataType:'html',
                ...
                $("#ref").click(function () {
                    ...
                    $("#ht_number").val("");
                    $("#express_number").val("");
                    var href = "${ctx}/admin/express/order/list?currentPage=1&exp_ord_state=${retInfo.obj.exp_ord_state}&memb_type=4&father_id=${funcions.obj.father_id}";
                    $.ajax({
                        type:'GET',
                        url:href,
                        dataType:'html',
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.mark == "0") {
                                ...
                                var href = "${ctx}/admin/express/order/searchList?currentPage=1&exp_ord_state=${retInfo.obj.exp_ord_state}&add_mobile_phone=${retInfo.obj.add_mobile_phone}&ht_number=${retInfo.obj.ht_number}&express_number=${retInfo.obj.express_number}&memb_type=4&father_id=${funcions.obj.father_id}";
