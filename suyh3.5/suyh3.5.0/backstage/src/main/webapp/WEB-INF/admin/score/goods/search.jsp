    ...
    <div class="centercontent tables">
        <div id="contentwrapper" class="contentwrapper">
                ...
                <div class="search_input">
                    <div id="search" style="display: none">
                        <p>
                            ...
                            <option value="2" <c:if test="${retInfo.obj.goods_type==2}">selected</c:if>>无限制</option>
                            <option value="1" <c:if test="${retInfo.obj.goods_type==1}">selected</c:if>>每天限制一次</option>
                        </select>
                        </p>
                        <p>
                            发件区域:
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    var href = ctx + "/admin/score/goods/search?currentPage="+n+"&goods_state=" +
                        "${retInfo.obj.goods_state}&goods_type=${retInfo.obj.goods_type}&region_id=" +
                        "${retInfo.obj.region_id}&express_id=${retInfo.obj.express_id}&father_id=${funcions.obj.father_id}";
            ...
            <script type="text/javascript">
                ...
                function updateState(goods_id ,goods_state){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            if(data.mark=="0"){
                                var href = ctx + "/admin/score/goods/search?currentPage=1&goods_state=" +
                                    "${retInfo.obj.goods_state}&goods_type=${retInfo.obj.goods_type}&region_id=" +
                                    "${retInfo.obj.region_id}&express_id=${retInfo.obj.express_id}&father_id=${funcions.obj.father_id}";
