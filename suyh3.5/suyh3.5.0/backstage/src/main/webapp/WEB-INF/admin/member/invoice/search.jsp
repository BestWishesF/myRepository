        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    $.ajax({
                        type:'GET',
                        url:"${ctx}/admin/member/index?father_id=5&currentPage=" + n +"&father_id=${funcions.obj.father_id}",
                        dataType:'html',
            ...
            <script type="text/javascript">
                $("#btn_assign").click(function () {
                    ...
                    $.ajax({
                        type:'GET',
                        url:"${ctx}/admin/member/invoice/searchList?father_id=6&currentPage=1&memb_id=${retInfo.obj.memb_id}&mobile="+$("#mobile").val()+"&state="+$("#state").val(),
                        dataType:'html',
                        success:function(data){
                            $("#main").html(data);
                        },
