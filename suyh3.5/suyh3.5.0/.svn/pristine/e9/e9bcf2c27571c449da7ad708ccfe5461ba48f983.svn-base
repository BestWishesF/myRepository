 ...
 */
public class GetuiAndroidAgentUtil {

    private static Logger logger = Logger.getLogger(GetuiAndroidAgentUtil.class);
    ...
    public static void pushAgent(PushParamsDto pushParamsDto){
        ...
        try {
            IGtPush push = new IGtPush("http://sdk.open.api.igexin.com/apiex.htm", Constant.GETUI_AGENT_APPKEY, Constant.GETUI_AGENT_MASTERSECRET);
            ...
            // 配置通知栏图标
            map.put("logo_url", "agent_logo.png");
            ...
            target.setAppId(Constant.GETUI_AGENT_APPID);
            ...
            if (ret != null) {
                logger.error("======error:" + ret.getResponse().toString() + "======");
            } else {
