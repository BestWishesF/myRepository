package cn.hotol.app.common.oss;
...
public class OssUtil {
  ...
  private final static OSSClient client=new OSSClient(Constant.accessKeyId, Constant.accessKeySecret);
  private final static String bucketName=Constant.MALL_bucketName;
...
//}
  ...
  public static String getFileAddress(String key) {
      ...
      return Constant.DOMAIN+fileFormat(key);
  }
  /**Purpose:验证key是否存在
   * @author 
