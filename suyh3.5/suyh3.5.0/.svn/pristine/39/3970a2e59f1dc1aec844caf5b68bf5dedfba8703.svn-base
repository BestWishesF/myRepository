        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="details">
                    <div class="search_input">
                        <div id="search" style="display: none">
                            <p>
                            &nbsp;&nbsp;&nbsp;&nbsp;id:<input type="text" name="memb_id" id="memb_id"/></p>
                            <p>
                                名称:<input type="text" name="memb_nick_name" id="memb_nick_name"/></p>
                            <p>
                                手机:<input type="text" name="memb_phone" id="memb_phone"/></p>
                            <p>
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    $.ajax({
                        type:'GET',
                        url:"${ctx}/admin/member/search" + "?currentPage=" + n
                        + "&memb_id=${retInfo.obj.memb_id}&memb_name=${retInfo.obj.memb_name}&memb_phone=${retInfo.obj.memb_phone}&father_id=${funcions.obj.father_id}",
                        dataType:'html',
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.mark=="0"){
                    $.ajax({
                        type:'GET',
                        url:"${ctx}/admin/member/search" + "?currentPage=1"
                        + "&memb_id=${retInfo.obj.memb_id}&memb_name=${retInfo.obj.memb_name}&memb_phone=${retInfo.obj.memb_phone}",
                        dataType:'html',
                        success:function(data){
                            $("#main").html(data);
                        },
