        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="table">
                <c:if test="${retInfo.mark == 0}">
                    <c:forEach items="${retInfo.obj.list}" var="bean">
                        <c:if test="${bean.express_id==27}">
                            <table cellpadding="0" cellspacing="0"
                                   style="width: 9.6cm;border: solid 2px dodgerblue;margin-left: 0.1cm;float: left;">
                                <tr style="height: 0.8cm;">
                                    <td colspan="2" style="width: 3cm;">&nbsp;</td>
                                    <td colspan="2" style="width: 4.4cm;">&nbsp;</td>
                                    <td colspan="2"
                                        style="text-align: right;width: 2.2cm;font-size: 15px;font-family: 微软雅黑;">${bean.express_name}</td>
                                </tr>
                                <tr style="height: 1.5cm;">
                                    <td colspan="6"
                                        style="width: 9.6cm;border-top: solid 1px black;text-align: left;font-family: 微软雅黑;font-size: 35px;font-weight: bold;">${bean.marker}</td>
                                </tr>
                                <tr style="height: 1cm;">
                                    <td colspan="4"
                                        style="width: 7.4cm;border-top: solid 1px black;border-right: solid 1px black;text-align: left;font-family: 微软雅黑;font-size: 19px;">${bean.package_name}</td>
                                    <td colspan="2"
                                        style="width: 2.2cm;border-top: solid 1px black;text-align: left;font-family: 微软雅黑;font-size: 19px;font-weight: bold;">${bean.package_code}</td>
                                </tr>
                                <tr style="height: 1.8cm;">
                                    ...
                                    <td colspan="3"
                                        ...
                                        <div style="width: 6.9cm;height: 1.8cm;">
                                            <p style="margin: 0;line-height: 0.6cm;height: 0.6cm;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                            <p style="margin: 0;height: 1.2cm;line-height: 0.6cm;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                        </div>
                                    </td>
                                ...
                                <tr style="height: 1.2cm;">
                                    ...
                                    <td colspan="3"
                                        ...
                                        <div style="width: 6.9cm;height: 1.2cm;">
                                            <p style="margin: 0;line-height: 0.4cm;height: 0.4cm;">${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                            <p style="margin: 0;height: 0.8cm;line-height: 0.4cm;">${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="height: 2.5cm;">
                                    <td colspan="6" style="width: 9.6cm;border-top: solid 1px black;">
                                            <%--<img src="${ctx}/genbc?type=code128&msg=${bean.express_number}&fmt=png"
                                                 style="height: 2cm;margin-top: 0.2cm;width: 7cm;"/>--%>
                                        <div id="express_no1${bean.exp_ord_clt_id}" style="margin-top: 0.1cm;"></div>
                                        <script>
                                            $("#express_no1${bean.exp_ord_clt_id}").empty().barcode("" +${bean.express_number}, "code128", {
                                                barWidth: 2,
                                                barHeight: 60,
                                                showHRI: true
                                            });
                                ...
                                <tr style="height: 1.4cm;">
                                    ...
                                    <td colspan="4" style="width: 6.6cm;border-top: solid 1px black;">
                                        ...
                                        <div id="express_no2${bean.exp_ord_clt_id}" style="margin-top: 0.1cm;float: right;"></div>
                                        <script>
                                            $("#express_no2${bean.exp_ord_clt_id}").empty().barcode("" +${bean.express_number}, "code128", {
                                                barWidth: 1,
                                                barHeight: 30,
                                                showHRI: true
                                            });
                                ...
                                <tr style="height: 1.2cm;">
                                    ...
                                    <td colspan="4"
                                        ...
                                        <div style="width: 7.4cm;height: 1.2cm;">
                                            <p style="margin: 0;height: 0.4cm;line-height: 0.4cm;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                            <p style="margin: 0;height: 0.8cm;line-height: 0.4cm;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                        </div>
                                    </td>
                                ...
                                <tr style="height: 1.2cm;">
                                    ...
                                    <td colspan="4"
                                        ...
                                        <div style="width: 7.2cm;height: 1.2cm;">
                                            <p style="margin: 0;height: 0.4cm;line-height: 0.4cm;">${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                            <p style="margin: 0;height: 0.8cm;line-height: 0.4cm;">${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="height: 2.1cm;">
                                    <td colspan="6"
                                        style="width: 9.6cm;height: 2.1cm;border-top: solid 1px black;font-family: 微软雅黑;font-size: 10px;text-align: left;">
                                        <div style="width: 9.6cm;height: 1.6cm;position: relative;">
                                            <p style="margin: 3px;"><span>${bean.category}</span></p>
                                            <p style="position: absolute;bottom: 0px;right: 0px;margin: 0px;"
                                               id="hotol_id">${bean.ht_number}</p>
                                        </div>
                        ...
                        <c:if test="${bean.express_id==28}">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 9.6cm;margin-left: 0.1cm;float: left;">
                                ...
                                <tr style="height: 2cm;">
                                    ...
                                    <td colspan="2" class="td1"
                                        ...
                                        <div style="height: 2cm;line-height: 1cm;">
                                            <p style="height: 0.8cm;line-height: 0.8cm;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                            <p style="height: 1.2cm;line-height: 0.6cm;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                        </div>
                                    </td>
                                    <td colspan="2" class="td1" rowspan="2" style="width: 3cm;font-size: 10px;">
                                        <p>件数：1/1</p>
                                        <p>计费重量：${bean.weight}Kg</p>
                                        <p>付款方式：寄付</p>
                                        <p>是否保价：</p>
                                        <p>签单返还：</p>
                                        <p>代收金额：</p>
                                ...
                                <tr style="height: 1cm;">
                                    ...
                                    <td colspan="2" class="td1"
                                        ...
                                        <div style="height: 1cm;">
                                            <p style="height: 0.35cm;">${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                            <p style="height: 0.65cm;line-height: 0.32cm;">${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr style="height: 1.4cm;">
                                    ...
                                    <td colspan="2" class="td1"
                                        ...
                                        <div style="height: 1.4cm;">
                                            <p style="height: 0.4cm;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                            <p style="height: 1cm;line-height: 0.5cm;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                        </div>
                                    </td>
                                ...
                                <tr style="height: 1cm;">
                                    ...
                                    <td colspan="2" class="td1"
                                        style="width: 6.1cm;font-family: 微软雅黑;font-size: 10px;text-align: left;">
                                        <div style="height: 1cm;">
                                            <p style="height: 0.3cm;">${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                            <p style="height: 0.7cm;line-height: 0.35cm;">${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <c:if test="${bean.express_id==29}">
                            ...
                            <div style="float: left;width: 9.8cm;">
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 9.8cm;margin-left: 0.1cm;">
                                    <tr style="height: 1.8cm;">
                                        <td colspan="5" class="td2" style="position: relative;text-align: center;">
                                                <%--<img src="${ctx}/genbc?type=code128&msg=${bean.express_number}-1-1-&fmt=png"
                                                     style="height: 1.5cm;margin-top: 0.1cm;width: 9cm;"/>--%>
                                            <div id="express_no1${bean.exp_ord_clt_id}" class="barcode" style="margin-top: 0.3cm;margin-left: 1.5cm;"></div>
                                            <script>
                                                $("#express_no1${bean.exp_ord_clt_id}").html(code128("${bean.express_number}-1-1-","A",1));
                                            </script>
                                            <span style="position: absolute;top: 1.5cm;right: 1cm;font-size: 10px;">${bean.weight}KG</span>
                                        </td>
                                    </tr>
                                    <tr style="height: 1.3cm;">
                                        <td colspan="2" class="td3" style="width: 4.9cm;">
                                            <p style="font-family: 黑体;font-size: 10px;">${bean.sourcet_sort_center_name}</p>
                                            <div style="font-family: 黑体;font-size: 20px;width: 100%;text-align: center;">${bean.original_cross_code}</div>
                                        </td>
                                        <td colspan="3" class="td1" style="width: 4.9cm;">
                                            <p style="font-family: 黑体;font-size: 10px;">${bean.target_sort_center_name}</p>
                                            <div style="font-family: 黑体;font-size: 20px;width: 100%;text-align: center;">${bean.destination_cross_code}</div>
                                        </td>
                                    </tr>
                                    <tr style="height: 0.7cm;">
                                        <td class="td3" style="width: 0.7cm;">&nbsp;</td>
                                        <td class="td1"
                                            style="font-family: 黑体;font-size: 16px;text-align: center;width: 4.2cm;">${bean.site_name}</td>
                                        <td class="td1" style="width: 1cm;font-family: 黑体;font-size: 16px;text-align: center;"
                                            id="road">${bean.road}</td>
                                    ...
                                    <tr style="height: 0.9cm;">
                                        ...
                                        <td class="td1" rowspan="2" colspan="2"
                                            ...
                                            <div style="width: 100%;height: 1.7cm;line-height: 0.85cm;">
                                                <p style="line-height: 0.42cm;height: 0.85cm;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                                <p style="line-height: 0.42cm;height: 0.85cm;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                            </div>
                                        </td>
                                ...
                                <div style="font-family: 黑体;font-size: 9px;height: 15px;width: 6.5cm;text-align: right;">${bean.print_day}</div>
                                <table cellpadding="0" cellspacing="0" border="0" style="width: 9.8cm;margin-left: 0.1cm;">
                                    <tr style="height: 0.7cm;font-family: 黑体;font-size: 13px;">
                                        <td class="td2" colspan="4" style="text-align: center;">
                                            运单号&nbsp;&nbsp;${bean.express_number}</td>
                                    </tr>
                                    <tr style="height: 1.7cm;">
                                        <td class="td3" colspan="2" style="width: 5.9cm;">
                                            <div style="font-family: 黑体;font-size: 10px;">客户信息:<span>${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</span>
                                            </div>
                                            <div>
                                                    <%--<img src="${ctx}/genbc?type=code128&msg=${bean.express_number}&fmt=png"
                                                         style="height: 1.3cm;width: 5.9cm;"/>--%>
                                                <div id="express_no2${bean.exp_ord_clt_id}" class="barcode" style="margin-top: 0.1cm;margin-left: 10px;"></div>
                                                <script>
                                                    $("#express_no2${bean.exp_ord_clt_id}").html(code128("${bean.express_number}","A",1));
                                                </script>
                                            </div>
                                        </td>
                                    ...
                                    <tr style="height: 0.7cm;">
                                        <td colspan="2" class="td3" style="width: 5.9cm;font-family: 黑体;font-size: 6px;">
                                            <div style="width: 5.9cm;height: 0.7cm;line-height: 0.35cm;">
                                                <p>
                                                    寄方信息：${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                                <p>${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                            </div>
                                        </td>
                                        <td colspan="2" class="td1" style="width: 3.9cm;font-family: 黑体;font-size: 9px;">
                                            <div style="width: 3.8cm;height: 0.7cm;line-height: 0.35cm;">
                                                <p><font
                                                        style="font-size: 8px;">商家ID：</font><span>${bean.customer_code}</span>
                                                </p>
                                                <p><font style="font-size: 8px;">B商家订单号：</font><span
                                                        style="font-size: 5px;">${bean.ht_number}</span></p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr style="height: 0.7cm;">
                                        ...
                                        <td colspan="2" class="td1" style="width: 3.9cm;font-family: 黑体;font-size: 10px;">
                                            <div style="width: 3.8cm;height: 0.7cm;">
                                                ...
                                                <div style="width: 100%;text-align: center;">${bean.send_city}</div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" style="">
                                            <div style="font-family: 黑体;font-size: 10px;width: 6.5cm;text-align: right;">${bean.print_day}</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <c:if test="${bean.express_id==3520}">
                            <table style="width: 10cm;float: left;margin-left: 5px;" cellspacing="0" cellpadding="0">
                                <tr style="height: 1.3cm;">
                                ...
                                <tr style="height: 1.5cm;">
                                    ...
                                    <c:if test="${bean.marker.length()>11&&bean.marker.length()<14}">
                                        <td colspan="5"
                                    ...
                                    <c:if test="${bean.marker.length()>13}">
                                        <td colspan="5"
                                ...
                                <tr style="height: 1.5cm;">
                                    ...
                                    <td colspan="4"
                                        ...
                                        <p style="padding: 0;margin: 0;">${bean.rev_name}&nbsp;&nbsp;${bean.rev_mobile}</p>
                                        <p style="padding: 0;margin: 0;">${bean.rev_pro}${bean.rev_city}${bean.rev_area}${bean.rev_address}</p>
                                    </td>
                                </tr>
                                <tr style="height: 1.2cm;">
                                    <td style="font-size: 11pt;font-family: 黑体;width: 0.9cm;border-top: solid 1px #000000;">
                                    ...
                                    <td colspan="4"
                                        ...
                                        <p style="padding: 0;margin: 0;">${bean.send_name}&nbsp;&nbsp;${bean.send_mobile}</p>
                                        <p style="padding: 0;margin: 0;">${bean.send_pro}${bean.send_city}${bean.send_area}${bean.send_address}</p>
                                    </td>
                                </tr>
                                ...
                                <tr style="height: 1.3cm;">
                                    <td colspan="5" style="text-align: right;border-top: solid 1px #000000;">
                                        ...
                                        <div id="express_no2${bean.exp_ord_clt_id}" style="margin-top: 1px;float: right;margin-right: 15px;"></div>
                                        <script>
                                            $("#express_no2${bean.exp_ord_clt_id}").empty().barcode("" +${bean.express_number}, "code128", {
                                                barWidth: 1,
                                                barHeight: 30,
                                ...
                                <tr style="height: 3cm;">
                                    <td colspan="5"
                                        ...
                                        <span style="position: absolute;bottom: 40px;right: 20px;">${bean.category}</span>
                                        <span style="position: absolute;bottom: 5px;left: 2px;height: 10pt;">${bean.ht_number}</span>
            ...
            <script type="text/javascript">
                ...
                function expressPrint() {
                    ...
                    var href = "${ctx}/admin/express/order/batchPrint?exp_ord_id=${retInfo.obj.exp_ord_id}";
                    $.ajax({
                        type:'GET',
                        url:href,
                        dataType:'html',
