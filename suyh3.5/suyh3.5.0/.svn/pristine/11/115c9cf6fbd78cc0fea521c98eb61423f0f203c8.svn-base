    ...
    <div class="centercontent tables">
        <div id="contentwrapper" class="contentwrapper">
                                ...
                                <c:forEach items="${funcions.obj.sonFuncion}" var="funcion">
                                    <c:choose>
                                        ...
                                        <c:when test="${funcion.func_name == '指派'}">
                                            <c:if test="${retInfo.obj.exp_ord_state == 1}">
                                                <a class="btn_a" onclick="assignExpOrd(${bean.exp_ord_id})" href="###">指派</a>||
                                            </c:if>
                                        </c:when>
            ...
            <script type="text/javascript">
                ...
                function page(n) {
                    var href = "${ctx}/admin/express/order/searchList?currentPage=" + n + "&exp_ord_state=${retInfo.obj.exp_ord_state}&add_mobile_phone=${retInfo.obj.add_mobile_phone}&ht_number=${retInfo.obj.ht_number}&express_number=${retInfo.obj.express_number}&memb_type=0&father_id=${funcions.obj.father_id}";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.mark == "0") {
                                ...
                                var href = "${ctx}/admin/express/order/searchList?currentPage=1&exp_ord_state=${retInfo.obj.exp_ord_state}&add_mobile_phone=${retInfo.obj.add_mobile_phone}&ht_number=${retInfo.obj.ht_number}&express_number=${retInfo.obj.express_number}&memb_type=0&father_id=${funcions.obj.father_id}";
