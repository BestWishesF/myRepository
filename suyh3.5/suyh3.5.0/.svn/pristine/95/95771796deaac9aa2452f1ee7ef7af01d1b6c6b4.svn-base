...
public class AddressDto {
    ...
    public AddressDto(String country, int country_code, String province, String city, String district, String adcode,
                      String street, String street_number, String direction, String distance){
