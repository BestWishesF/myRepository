...
public class TdHtMembThirdLogin implements java.io.Serializable {
	...
	private Date thr_register_time;//时间
	...
	public Date getThr_register_time() {
		return thr_register_time;
	}

	public void setThr_register_time(Date thr_register_time) {
